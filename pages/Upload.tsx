...
const Upload: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      xhr.open("POST", "https://nonprohibitory-katheryn-unbewitched.ngrok-free.dev/api/upload");
  ...
  const renderSelectionMode = () => (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8 px-4">
        <motion.div
          whileHover={{ y: -5 }}
          className="bg-white p-8 rounded-3xl border border-cream-200 shadow-lg cursor-pointer hover:shadow-xl transition-all group md:col-span-2 max-w-2xl mx-auto"
          onClick={() => {
            if (!isLoggedIn) {
              handleLoginRedirect();
              return;
      ...
      {uploadResult ? (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/5 space-y-6">
            ...
            {/* Design Specifications */}
            <div className="bg-white p-6 rounded-2xl border border-cream-100 shadow-sm">
