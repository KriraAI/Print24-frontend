  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://nonprohibitory-katheryn-unbewitched.ngrok-free.dev/api/auth/register",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen bg-cream-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="max-w-lg w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-cream-100 relative z-10"
      >
